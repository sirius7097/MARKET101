...
╚═══════════════════════════════╝`}
              ...
              <div className="sm:hidden mb-4">
                <h3 className="text-xl text-primary font-bold">开阳 KAIYANG</h3>
                <p className="text-sm text-muted-foreground">主流币波段策略</p>
              </div>
              ...
              <div className="mt-6 pt-4 border-t border-border">
                <p className="text-xs text-muted-foreground leading-relaxed">
                  ...
                  专注于主流资产的中长期波段交易，通过多维度技术指标与市场情绪分析，精准捕捉趋势拐点，实现稳健收益。
                </p>
              </div>
              ...
              <div className="mt-4 grid grid-cols-2 gap-2 text-xs">
                ...
                <div className="border border-border px-2 py-1">
                  <span className="text-muted-foreground">[</span>
                  <span className="text-primary">稳健收益</span>
                  <span className="text-muted-foreground">]</span>
                </div>
              </div>
            </div>
...
╚═══════════════════════════════╝`}
              ...
              <div className="sm:hidden mb-4">
                ...
                <p className="text-sm text-muted-foreground">山寨币暴涨捕捉策略</p>
              </div>
              ...
              <div className="mt-6 pt-4 border-t border-border">
                <p className="text-xs text-muted-foreground leading-relaxed">
                  ...
                  实时监控山寨币市场异动，结合链上数据与资金流向分析，快速识别潜力标的，捕捉短期爆发行情。
                </p>
              </div>
              ...
              <div className="mt-4 grid grid-cols-2 gap-2 text-xs">
                ...
                <div className="border border-border px-2 py-1">
                  <span className="text-muted-foreground">[</span>
                  <span className="text-accent">高收益</span>
                  <span className="text-muted-foreground">]</span>
                </div>
                <div className="border border-border px-2 py-1">
                  <span className="text-muted-foreground">[</span>
                  <span className="text-accent">链上分析</span>
                  <span className="text-muted-foreground">]</span>
                </div>
                <div className="border border-border px-2 py-1">
                  <span className="text-muted-foreground">[</span>
