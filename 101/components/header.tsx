...
const navItems = [
  { name: "策略.sys", href: "#strategies" },
  { name: "定价.cfg", href: "#pricing" },
  { name: "社群.link", href: "#telegram" },
]
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-14">
          ...
          <nav className="hidden md:flex items-center gap-1">
            ...
            <span className="ml-4 text-xs text-muted-foreground border border-border px-2 py-1">SYS_TIME: {time}</span>
          </nav>
